...
const ErrorAlert = (props) => {
  return (
    <div className='m-4'>
   {
    props.show ? <div className="bg-red-100 border-t-4 border-red-500 rounded-b text-red-900 px-4 py-3 shadow-md" role="alert">
    <div className="flex">
      ...
      <div>
        ...
        <p className="text-sm">Something seriously bad happened.</p>
      </div>
    </div>
  </div> : <p></p>
   }
